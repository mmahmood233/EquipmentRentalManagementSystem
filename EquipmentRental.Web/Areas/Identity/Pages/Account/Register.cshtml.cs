...
namespace AdvancedProgrammingASPProject.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly ProjectDBContext _mainDbContext;
        ...
        public RegisterModel(
            ...
            ProjectDBContext mainDbContext)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var mainDbUser = new ProjectDBClassLibrary.Model.User
                    {
                    ...
                    _mainDbContext.Users.Add(mainDbUser);
                    await _mainDbContext.SaveChangesAsync();

                    // Save main DB user ID into Identity user (link them)
                    user.MainUserId = mainDbUser.UserId;
